<div align="center">
   <br/>
   <img src="./assets/MetricSub.png" alt="Banner">
   <br/>
   <div>
   ...
   <h3 align="center">MetricSub | React Native Subscription Management App</h3>
...
- **[Clerk](https://clerk.com/)** provides a complete suite of authentication and user management tools. It handles secure sign-ins, session management, and integrates seamlessly with billing workflows.
...
- **[CodeRabbit](https://coderabbit.ai/)** is an AI-powered code review assistant. It provides deep, context-aware feedback on pull requests, helping maintain high code quality and catching potential bugs before they reach production.
...
```bash
git clone https://github.com/itzzSVR-tech/metricsub.git
cd metricsub
```
